export const PORTFOLIO_GALLERIES = {
  ...
  bath: [
    ...
    { src: '/Portfolio/bathroom-renovation-east-london-clean-handover-shower-niche.webp', alt: 'Clean finished shower niche with warm lighting and black brassware', label: 'Detail' },
    { src: '/Portfolio/bathroom-renovation-east-london-clean-handover-floating-oak-vanity.webp', alt: 'Clean floating oak vanity with twin basins and matte black wall taps', label: 'Vanity' },
    { src: '/Portfolio/bathroom-renovation-east-london-clean-handover-backlit-mirror.webp', alt: 'Clean backlit bathroom mirror and vanity lighting after fitting', label: 'Lighting' },
    { src: '/Portfolio/bathroom-renovation-east-london-clean-handover-wide-shot.webp', alt: 'Clean completed East London bathroom renovation wide shot after fitting', label: 'After' },
    { src: '/Portfolio/bathroom-renovation-east-london-clean-handover-final-detail.webp', alt: 'Clean completed bathroom vanity and shower finishing detail', label: 'Final Detail' },
  ],
  painting: [
