      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-nowrap justify-center gap-1.5 sm:gap-4 mb-6 sm:mb-10" data-reveal>
          <div className="flex items-center gap-1 sm:gap-2 bg-white px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-[#D4AF37]/20 shadow-sm">
            ...
            <span className="font-['Source_Serif_4'] text-[0.75rem] sm:text-[0.875rem] font-semibold text-[#1C1714]">9.97/10</span>
            <span className="font-['Source_Serif_4'] text-[0.6875rem] sm:text-[0.8125rem] text-[#5A5048]">Checkatrade</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-2 bg-white px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-[#D4AF37]/20 shadow-sm">
            <svg className="hidden sm:block w-5 h-5 fill-[#D4AF37]" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            <span className="font-['Source_Serif_4'] text-[0.75rem] sm:text-[0.875rem] font-semibold text-[#1C1714]">4.9/5</span>
            <span className="font-['Source_Serif_4'] text-[0.6875rem] sm:text-[0.8125rem] text-[#5A5048]">MyBuilder</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-2 bg-white px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-[#D4AF37]/20 shadow-sm">
            ...
            <span className="font-['Source_Serif_4'] text-[0.75rem] sm:text-[0.875rem] font-semibold text-[#1C1714]">30+</span>
            <span className="font-['Source_Serif_4'] text-[0.6875rem] sm:text-[0.8125rem] text-[#5A5048]">Reviews</span>
          </div>
        </div>
        ...
        <div className="relative" data-reveal>
          <div className="bg-white p-5 sm:p-8 md:p-10 rounded-xl border border-[#D4AF37]/15 shadow-sm">
            ...
            <p className="text-[#1C1714] text-[1rem] sm:text-[1.125rem] md:text-[1.25rem] leading-[1.75] sm:leading-[1.82] mb-5 sm:mb-8 italic font-['Source_Serif_4']">
              &ldquo;{r.text}&rdquo;
            </p>

            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h4 className="font-['Cormorant_Garamond'] text-[1.125rem] font-semibold text-[#1C1714] mb-1">
                  {r.name}
                </h4>
                <p className="text-[#5A5048] text-[0.875rem] font-['Source_Serif_4'] leading-snug">
