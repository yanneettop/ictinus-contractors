...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#F5F0E6]">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap justify-center gap-4 mb-10" data-reveal>
        ...
        <div className="relative" data-reveal>
          <div className="bg-white p-8 md:p-10 rounded-xl border border-[#D4AF37]/15 shadow-sm">
            <svg className="w-10 h-10 text-[#D4AF37]/50 mb-5" fill="currentColor" viewBox="0 0 24 24">
