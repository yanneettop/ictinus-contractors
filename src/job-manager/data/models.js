 ...
 * @typedef {{id:string,projectId:string,type:string,title:string,startDate:string,endDate:string,allDay:boolean,location:string,notes:string,colourCategory:string,googleCalendarEventId:string|null,syncStatus:'not_configured'|'pending'|'synced'|'failed',lastSyncedAt:string|null}} ProjectEvent
