 ...
 * @typedef {{id:string,projectId:string,type:string,title:string,startDate:string,endDate:string,allDay:boolean,location:string,notes:string,colourCategory:string,googleCalendarEventId:string|null}} ProjectEvent
 ...
 * @typedef {{id:string,projectId:string,type:string,name:string,url:string,createdAt:string,uploadedBy:string}} Document
 ...
 * @typedef {{id:string,projectId:string,userId:string,action:string,createdAt:string}} ActivityLog
 */
