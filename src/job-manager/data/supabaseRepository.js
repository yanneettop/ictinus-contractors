...
const maps = {
  ...
  activities: (row) => ({ id: row.id, projectId: row.project_id, userId: row.user_id, action: row.action, actorType: row.actor_type, actorName: row.actor_name, source: row.source, entityType: row.entity_type, entityId: row.entity_id, previousValues: row.previous_values, newValues: row.new_values, createdAt: row.created_at }),
