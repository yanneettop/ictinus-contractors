import { CalendarDays, ChevronDown, CreditCard, FolderKanban, LayoutDashboard, LogOut, Settings, X } from 'lucide-react'
...
export default function ManagerLayout() {
  const { user, logout, error, setError } = useJobManager()
  ...
  return <div className="jm-shell">
    <aside className="jm-sidebar">
      ...
      <div className="jm-sidebar-note"><strong>Private workspace</strong><span>Local demo data</span></div>
    </aside>
