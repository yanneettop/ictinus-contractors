...
export class IntegrationService {
  ...
  async createLead(input) { const values={...leadValues(input),created_by:null,updated_by:null}; const row=await this.repository.insert('leads',values); await this.audit('lead.created','lead',row.id,null,null,row); return leadView(row) }
